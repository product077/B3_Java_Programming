...
public class AddElement {
    public static void main(String[] args) {
        ...
        int[] firstArr = new int[key.nextInt()]; // 3(size of array)


        for (int i = 0; i < firstArr.length; i++) {

            System.out.print("Enter your data/value: ");//System.out.println("Please, enter your number of element one by one pressing enter");
